...
public class InfluxDbUtil {
    ...
    private static String measurements = "test"; // 表

    private InfluxDB influxDB;

    public InfluxDbUtil(String openurl, String username, String password, String database, String measurements) {
    ...
    public static InfluxDbUtil setUp() {
        // 创建连接
        InfluxDbUtil influxDbUtil = new InfluxDbUtil(openurl, username, password, database, measurements);
